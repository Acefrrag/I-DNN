...
if __name__ == "__main__":
    ...
    test_names = tests
    #["trace"+re.search(r"\d+",voltage_trace_name).group() for voltage_trace_name in voltage_trace_names]
    #DNNtest_ps = [vt1_p, vt2_p, vt8_p]
    ...
    ax.grid(True)
    #ax.set_ylim(10**(3), max(As)+10**(math.log10(max(As))+1))
    #plt.xticks(fontsize=10)
    # if enable_plot_save==True:
