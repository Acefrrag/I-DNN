...
Description:
    ...
    For some fitting the covariance matrix could not be estimated. 
...
if __name__ == "__main__":
    #ANALYSIS OF DIFFERENT VOLTAGE TRACES RESULTS FOR DIFFERENT NV_REG_FACTOR
    NV_REG_FACTOR = 2
    num_hidden_layers = 4
