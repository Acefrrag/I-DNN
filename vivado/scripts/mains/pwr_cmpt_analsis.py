...
import vt_results_analysis as vt_lib
...
if __name__ == "__main__":
    ...
    DB_results_DELAYS_path = "./results/4layer_80/powerpoint_voltagetrace2"
    DB_results_DELAYS_path = "./results/4layer_80/"+voltage_tracename
