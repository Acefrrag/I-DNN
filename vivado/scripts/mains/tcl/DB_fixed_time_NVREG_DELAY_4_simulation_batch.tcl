...
set fp [open ./results/DB_results_fixedtime_NVREG_DELAY_FACTOR4_voltage_trace1_4_2850_3250.txt w]
...
set number 1
set_value -radix unsigned /I_DNN_multiple_images_tb/hazard_threshold 2850
run 3000 us
